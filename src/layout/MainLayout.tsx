    ...
    return (
        <main>
            ...
            <div className="h-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-8 gap-4">
                ...
                {!currentPath.includes('article') && !currentPath.includes('global') && (<div className="md:col-span-1 lg:col-span-2 bg-[repeating-linear-gradient(-45deg,transparent,transparent_8px,#ccddf0_3px,#ccddf0_10px)] 
